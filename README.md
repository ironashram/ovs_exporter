...
```bash
# Linux AMD64
wget https://github.com/Liquescent-Development/ovs_exporter/releases/download/v2.8.0/ovs-exporter-2.8.0.linux-amd64.tar.gz
tar xvzf ovs-exporter-2.8.0.linux-amd64.tar.gz

# Linux ARM64
wget https://github.com/Liquescent-Development/ovs_exporter/releases/download/v2.8.0/ovs-exporter-2.8.0.linux-arm64.tar.gz
tar xvzf ovs-exporter-2.8.0.linux-arm64.tar.gz
```
